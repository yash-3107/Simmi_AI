<main class="flex-1 overflow-auto px-6 pt-4">
  <div id="flow-deployment-index-container" class="space-y-3">
      ...
      <nav class="MuiTypography-root MuiTypography-body1 MuiBreadcrumbs-root text-lg css-o3d33y"
        ...
        <ol class="MuiBreadcrumbs-ol css-nhb8h9">
          <li class="MuiBreadcrumbs-li">
            <div class="text-foreground capitalize max-w-96 truncate" id="components-index-breadcrumbs-0">Support</div>
          </li>
        </ol>
      </nav>
    </div>
    <div class="space-y-5">
      ...
      <div class="space-y-5">
        <p class="font-semibold text-2xl leading-[32.78px]">All Tickets</p>
      </div>
      <div class="w-full flex items-center justify-center">
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-10 max-w-5xl items-center justify-center">
          <div class="h-96 w-full flex justify-center col-span-2"><img
              src="https://vanij.adya.ai/assets/Support-DePiy9Nk.webp" alt="Start Building Your Space"
          ...
          <div class="col-span-3 flex flex-col gap-y-12">
            <div class="flex flex-col gap-y-4">
              ...
              <p class="text-sm text-foreground/50">You currently have no tickets. Begin by creating your first ticket
                and start managing your work efficiently.</p>
                ...
                type="button" id="all-ticket-list-create-new-project-button">Create New</button></span>
          </div>
        </div>
      </div>
    </div>
