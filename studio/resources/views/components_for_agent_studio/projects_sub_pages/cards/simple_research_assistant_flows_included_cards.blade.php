<link rel="stylesheet" href="{{ asset('agent_studio_css/simple_research_assistant_flows_included_cards.css')}}">
<div id="project-view-pre-built-flows-0-card-custom-card"
  ...
  <p class="text-sm text-muted-foreground line-clamp-2 flex-1">Researches companies, extracts key business data, and
    presents structured information for efficient analysis. </p>
...
<div id="project-view-pre-built-flows-1-card-custom-card"
  ...
  <p class="text-sm text-muted-foreground line-clamp-2 flex-1">Agent that generates focused plans, conducts web
    searches, and synthesizes findings into comprehensive reports.</p>
  <div class="pt-1 mt-auto">
    <div class="flex gap-2 items-start justify-between">
      <div dir="ltr" class="relative overflow-hidden w-full"
        style="position: relative; --radix-scroll-area-corner-width: 0px; --radix-scroll-area-corner-height: 0px;">
...
<div id="project-view-pre-built-flows-2-card-custom-card"
  ...
  <p class="text-sm text-muted-foreground line-clamp-2 flex-1">Generates targeted SEO keywords based on product
    information, pain points, and customer profiles for strategic marketing.</p>
  <div class="pt-1 mt-auto">
    <div class="flex gap-2 items-start justify-between">
      <div dir="ltr" class="relative overflow-hidden w-full"
        style="position: relative; --radix-scroll-area-corner-width: 0px; --radix-scroll-area-corner-height: 0px;">
