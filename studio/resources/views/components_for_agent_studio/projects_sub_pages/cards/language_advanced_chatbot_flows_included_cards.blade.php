<link rel="stylesheet" href="agent_studio_css/language_advanced_chatbot_flows_included_cards.css">
<div id="project-view-pre-built-flows-0-card-custom-card"
  ...
  <p class="text-sm text-muted-foreground line-clamp-2 flex-1">A Language chatbot is an AI-powered software that can
    simulate human-like conversations with users through text or voice, often used for customer service, support, and
    automation tasks.</p>
