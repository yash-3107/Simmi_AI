...
px-6 pt-4" style="height:90vh !important;overflow: scroll; width: 80vw;">
  <div id="projects-module-index-container" class="space-y-3">
    <div class="flex text-2xl gap-3 items-center" id="projects-module-index-breadcrumbs-container"><svg
        ...
        stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-file-chart-column w-5 h-5"
        aria-hidden="true" data-testid="icon-file-chart-column" style="stroke-width: 1.5;">
        ...
        <ol class="MuiBreadcrumbs-ol css-nhb8h9">
          <li class="MuiBreadcrumbs-li">
            <div class="hover:underline capitalize cursor-pointer max-w-72 truncate"
              id="projects-module-index-breadcrumbs-0">Observability</div>
          </li>
          <li aria-hidden="true" class="MuiBreadcrumbs-separator css-3mf706">/</li>
          <li class="MuiBreadcrumbs-li">
            <div class="text-foreground capitalize max-w-96 truncate" id="projects-module-index-breadcrumbs-1">Wallet
              usage</div>
          </li>
        </ol>
      </nav>
          ...
          <div class="w-full flex items-center justify-center">
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-10 max-w-5xl items-center justify-center">
              <div class="h-96 w-full flex justify-center col-span-2"><img
                  src="https://vanij.adya.ai/assets/WalletUsage-CKXWD5Ie.webp"
                  alt="Let's Start by Making Your First Transaction" class="h-full w-full object-contain"
                  draggable="false"></div>
              <div class="col-span-3 flex flex-col gap-y-12">
                <div class="flex flex-col gap-y-4">
                  <h1 class="text-foreground font-semibold text-xl">Let's Start by Making Your First Transaction</h1>
                  <p class="text-sm text-foreground/50">You currently have no transactions in your application.</p>
                </div>
              </div>
            </div>
          </div>
