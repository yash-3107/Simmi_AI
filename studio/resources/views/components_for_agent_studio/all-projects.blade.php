<div dir="ltr" data-orientation="horizontal" class="space-y-4">
  <div role="tablist" aria-orientation="horizontal"
    class="inline-flex h-9 items-center justify-center rounded-lg bg-muted p-1 text-muted-foreground" tabindex="0"
    data-orientation="horizontal" style="outline: none;"><button type="button" role="tab" aria-selected="false"
      aria-controls="radix-:r7a:-content-deployed" data-state="inactive" id="radix-:r7a:-trigger-deployed"
      ...
      tabindex="-1" data-orientation="horizontal" data-radix-collection-item="">Deployed</button><button type="button"
      role="tab" aria-selected="true" aria-controls="radix-:r7a:-content-ready-to-deploy" data-state="active"
      id="radix-:r7a:-trigger-ready-to-deploy"
      class="inline-flex items-center justify-center whitespace-nowrap rounded-md py-1 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow px-6"
      tabindex="0" data-orientation="horizontal" data-radix-collection-item="">All Projects</button></div>
  <div data-state="inactive" data-orientation="horizontal" role="tabpanel"
    aria-labelledby="radix-:r7a:-trigger-deployed" id="radix-:r7a:-content-deployed" tabindex="0"
    class="mt-2 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
    style="" hidden=""></div>
  <div data-state="active" data-orientation="horizontal" role="tabpanel"
    aria-labelledby="radix-:r7a:-trigger-ready-to-deploy" id="radix-:r7a:-content-ready-to-deploy" tabindex="0"
    class="mt-2 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2">
    <div class="space-y-4">
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-4">
          <div class="relative"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
              ...
              id="ready-projects-list-filters-search-bar-input" placeholder="Search..." value=""></div>
          <div role="group" class="MuiToggleButtonGroup-root bg-background rounded-lg css-7rg7fp"
            id="ready-to-deploy-view-toggle" aria-label="text alignment"><button
              ...
              tabindex="0" type="button" value="grid" aria-pressed="true" id="ready-to-deploy-view-toggle-grid"
              ...
              tabindex="0" type="button" value="list" aria-pressed="false" id="ready-to-deploy-view-toggle-list"
              aria-label="left aligned" data-state="closed"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
      ...
      <div>
        <div>
          <div class="grid grid-cols-[repeat(auto-fill,minmax(17rem,1fr))] gap-4"
            id="flow-deployment-projects-list-grid-view">
            <div id="components-variants-list-grid-view-0-custom-card"
              class="text-foreground rounded-xl hover:shadow-md transition-all duration-200 cursor-pointer bg-[#C7E7FA4D] h-fit">
              <div class="p-4 space-y-3">
                <div class="flex items-center justify-between">
                  <h2 class="font-semibold truncate" title="custom chatbot">custom chatbot</h2>
                </div>
                <div class="text-sm space-y-1 text-gray-600">
                  <div class="flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                      viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                      stroke-linejoin="round" class="lucide lucide-user w-4 h-4" aria-hidden="true"
                  ...
                  <div class="flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                      viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                      stroke-linejoin="round" class="lucide lucide-calendar w-4 h-4" aria-hidden="true"
              ...
              <div class="flex justify-between items-center bg-[#D0E4FE] p-4 py-2 rounded-b-xl">
                <div class="flex gap-2">
                  <div
                    class="inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 pointer-events-none border-transparent hover:bg-secondary/80 bg-white text-gray-700">
                    1 Flows</div>
                  <div
                    class="inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 pointer-events-none border-transparent hover:bg-secondary/80 bg-green-100 text-green-700">
                    1 Flows Ready to Deploy</div>
                </div>
              </div>
            </div>
          </div>
          <div class="flex w-full justify-center items-center mt-5 rounded-lg">
            <div
              ...
              <div class="MuiToolbar-root MuiToolbar-gutters MuiToolbar-regular MuiTablePagination-toolbar css-8nphli">
                ...
                <p class="MuiTablePagination-selectLabel css-1chpzqh" id=":r7n:">Per Page:</p>
                <div class="MuiInputBase-root MuiInputBase-colorPrimary MuiTablePagination-input css-rmmij8">
                  <div tabindex="0" role="combobox" aria-controls=":r7o:" aria-expanded="false" aria-haspopup="listbox"
                    aria-labelledby=":r7n: :r7m:" id=":r7m:"
