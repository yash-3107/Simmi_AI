          ...
          <div class="space-y-6">
            <div class="bg-card rounded-3xl p-6 ">
              <div class="space-y-6">
                <div class="flex flex-col space-y-3 text-center mb-2" style="opacity: 1; transform: none;">
                  ...
                  <p class="text-[15px] text-muted-foreground">Enter your email to sign in to your account</p>
                </div>
           ...
           A2 2 0 0 1 22 16.92z" />
                    ...
                    <button
                      ...
                      type="submit" id="login-continue-button">Continue<svg xmlns="http://www.w3.org/2000/svg"
