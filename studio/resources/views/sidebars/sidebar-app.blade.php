<div
    ...
    <div class="h-full flex flex-col">
        ...
        <nav class="space-y-1 p-2 flex-grow overflow-y-auto"><a id="sidebar-menu-item-app-studio-overview"
                ...
                class="flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition-all hover:bg-primary/10"
                href="/app-studio/apps" data-discover="true"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    stroke-linecap="round" stroke-linejoin="round"
                ...
                class="flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition-all hover:bg-primary/10"
                href="/app-studio/app-deployments" data-discover="true"><svg xmlns="http://www.w3.org/2000/svg"
                    width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-shuffle h-4 w-4 mr-1 shrink-0"
                    aria-hidden="true" data-testid="icon-shuffle" style="stroke-width: 1.5;">
                ...
                </svg><span class="truncate">App Deployments</span></a><a
                id="sidebar-menu-item-app-studio-observability"
                class="flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition-all hover:bg-primary/10"
