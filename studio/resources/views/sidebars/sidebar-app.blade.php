<div
    ...
    <div class="h-full flex flex-col">
        <div class="flex items-center justify-between ml-4 mr-2 pb-2 mb-2 border-b ">
            <div class="tracking-wide truncate">App Studio</div><button class="p-1 rounded-lg hover:bg-accent"
        ...
        <nav class="space-y-1 p-2 flex-grow overflow-y-auto"><a id="sidebar-menu-item-app-studio-overview"
                class="flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition-all hover:bg-primary/10" href=""
                ...
                </svg><span class="truncate">Overview</span></a><a id="sidebar-menu-item-app-studio-apps"
                class="flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition-all hover:bg-primary/10"
                href="/app-studio/apps" data-discover="true"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                </svg><span class="truncate">Apps</span></a><a id="sidebar-menu-item-app-studio-app-deployments"
                class="flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition-all hover:bg-primary/10"
                href="/app-studio/app-deployments" data-discover="true"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round" class="lucide lucide-shuffle h-4 w-4 mr-1 shrink-0" aria-hidden="true"
                    data-testid="icon-shuffle" style="stroke-width: 1.5;">
                ...
                </svg><span class="truncate">App Deployments</span></a><a id="sidebar-menu-item-app-studio-observability"
                class="flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition-all hover:bg-primary/10"
                href="/app-studio/observability" data-discover="true"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                </svg><span class="truncate">Observability</span></a>
            <div data-orientation="horizontal" role="none" class="shrink-0 bg-border h-[1px] w-full"></div><a
                ...
                class="flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition-all hover:bg-primary/10"
                href="/file-manager" data-discover="true"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round" class="lucide lucide-folders h-4 w-4 mr-1 shrink-0" aria-hidden="true"
                ...
                class="flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition-all hover:bg-primary/10"
                href="/key-vault" data-discover="true"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round" class="lucide lucide-key-round h-4 w-4 mr-1 shrink-0" aria-hidden="true"
