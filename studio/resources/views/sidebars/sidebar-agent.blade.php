<div
    ...
    <div class="h-full flex flex-col">
        <div class="flex items-center justify-between ml-4 mr-2 pb-2 mb-2 border-b ">
            <div class="tracking-wide truncate">Agent Studio</div><button class="p-1 rounded-lg hover:bg-accent"
        ...
        <nav class="space-y-1 p-2 flex-grow overflow-y-auto"><a id="sidebar-menu-item-agent-studio-overview"
                ...
                href="/agent-studio/component-deployment" data-discover="true"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-box h-4 w-4 mr-1 shrink-0"
